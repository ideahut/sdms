...
use \Ideahut\sdms\refproxy\internal\ProxyClass;
...
class ProxyClassFactoryImpl implements ProxyClassFactory
{
    ...
    public function get(\ReflectionClass $reflectionClass, $interfaces = [])
    {
        ...
        $builder->writeNamespace('Ideahut\sdms\refproxy\enhanced');
        ...
        return new ProxyClassImpl('\\Ideahut\\sdms\\refproxy\\enhanced\\' . $enhancedClassName, $reflectionClass, $interfaces);
    }
